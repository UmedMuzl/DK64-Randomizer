...
EnemyMetaData = {
    ...
    Enemies.SpiderSmall: EnemyData(name="Spider", crown_weight=7, disruptive=1, crown_enabled=False, minigame_enabled=False),  # with projectiles, disruptive will need to be set to 2
