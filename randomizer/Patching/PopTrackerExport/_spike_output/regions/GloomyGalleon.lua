...
M.regions["GloomyGalleonEntryHandler"] = {
  ...
  exits = {
    { dest = "GloomyGalleonLobby", logic = function() return true end, exitShuffleId="Transitions.GalleonToIsles" },
...
M.regions["Lighthouse"] = {
  ...
  exits = {
    { dest = "LighthousePlatform", logic = function() return true end, exitShuffleId="Transitions.GalleonLighthouseToLighthouseArea" },
...
M.regions["MermaidRoom"] = {
  ...
  exits = {
    { dest = "LighthouseUnderwater", logic = function() return true end, exitShuffleId="Transitions.GalleonMermaidToLighthouseArea" },
  },
}
...
M.regions["SickBay"] = {
  ...
  exits = {
    { dest = "LighthousePlatform", logic = function() return state.cannons() end, exitShuffleId="Transitions.GalleonSickBayToLighthouseArea" },
  },
}
...
M.regions["SealRace"] = {
  ...
  exits = {
    { dest = "Shipyard", logic = function() return ((not state.IsLavaWater()) or (state.Melons() >= 2)) end, exitShuffleId="Transitions.GalleonSealToShipyard" },
  },
}
...
M.regions["TinyChest"] = {
  ...
  exits = {
    { dest = "TreasureRoom", logic = function() return true end, exitShuffleId="Transitions.GalleonChestToTreasure" },
  },
}
...
M.regions["Submarine"] = {
  ...
  exits = {
    { dest = "ShipyardUnderwater", logic = function() return true end, exitShuffleId="Transitions.GalleonSubmarineToShipyard" },
  },
}
...
M.regions["Mechafish"] = {
  ...
  exits = {
    { dest = "ShipyardUnderwater", logic = function() return true end, exitShuffleId="Transitions.GalleonMechFishToShipyard" },
  },
}
...
M.regions["LankyShip"] = {
  ...
  exits = {
    { dest = "ShipyardUnderwater", logic = function() return true end, exitShuffleId="Transitions.GalleonLankyToShipyard" },
...
M.regions["TinyShip"] = {
  ...
  exits = {
    { dest = "ShipyardUnderwater", logic = function() return true end, exitShuffleId="Transitions.GalleonTinyToShipyard" },
...
M.regions["BongosShip"] = {
  ...
  exits = {
    { dest = "ShipyardUnderwater", logic = function() return true end, exitShuffleId="Transitions.GalleonBongosToShipyard" },
...
M.regions["GuitarShip"] = {
  ...
  exits = {
    { dest = "ShipyardUnderwater", logic = function() return true end, exitShuffleId="Transitions.GalleonGuitarToShipyard" },
...
M.regions["TromboneShip"] = {
  ...
  exits = {
    { dest = "ShipyardUnderwater", logic = function() return true end, exitShuffleId="Transitions.GalleonTromboneToShipyard" },
...
M.regions["SaxophoneShip"] = {
  ...
  exits = {
    { dest = "ShipyardUnderwater", logic = function() return true end, exitShuffleId="Transitions.GalleonSaxophoneToShipyard" },
...
M.regions["TriangleShip"] = {
  ...
  exits = {
    { dest = "ShipyardUnderwater", logic = function() return true end, exitShuffleId="Transitions.GalleonTriangleToShipyard" },
    { dest = "GuitarShip", logic = function() return state.CanPhaseswim() end },
    { dest = "TromboneShip", logic = function() return state.CanPhaseswim() end },
  },
}
