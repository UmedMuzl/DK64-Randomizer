...
M.regions["JungleJapesEntryHandler"] = {
  ...
  exits = {
    { dest = "JungleJapesLobby", logic = function() return true end, exitShuffleId="Transitions.JapesToIsles" },
...
M.regions["JapesPaintingRoomHill"] = {
  ...
  exits = {
    { dest = "JungleJapesMain", logic = function() return true end },
    { dest = "JapesLankyCave", logic = function() return (state.hasMoveSwitchsanity("JapesPainting", false) or state.CanSkew(true) or state.CanSkew(false) or state.CanPhase()) end, exitShuffleId="Transitions.JapesMainToLankyCave" },
  },
}
...
M.regions["JapesLankyCave"] = {
  ...
  exits = {
    { dest = "JapesPaintingRoomHill", logic = function() return true end, exitShuffleId="Transitions.JapesLankyCaveToMain" },
  },
}
...
M.regions["JapesCatacomb"] = {
  ...
  exits = {
    { dest = "JungleJapesStart", logic = function() return state.cannons() end, exitShuffleId="Transitions.JapesCatacombToMain" },
  },
}
