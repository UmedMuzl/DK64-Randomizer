...
M.regions["Treehouse"] = {
  ...
  exits = {
    { dest = "TrainingGrounds", logic = function() return true end, exitShuffleId="Transitions.IslesTreehouseToStart" },
  },
}
...
M.regions["TrainingGrounds"] = {
  ...
  exits = {
    { dest = "IslesMain", logic = function() return (state.Slam() or settings.fast_start_beginning_of_game()) end, exitShuffleId="Transitions.IslesStartToMain" },
    { dest = "Treehouse", logic = function() return state.climbing() end, exitShuffleId="Transitions.IslesStartToTreehouse" },
...
M.regions["IslesMain"] = {
  ...
  exits = {
    { dest = "TrainingGrounds", logic = function() return true end, exitShuffleId="Transitions.IslesMainToStart" },
    { dest = "OuterIsles", logic = function() return true end },
    { dest = "JungleJapesLobby", logic = function() return (settings.open_lobbies() or state.event("KLumsyTalkedTo") or state.CanPhase() or state.CanSTS()) end, exitShuffleId="Transitions.IslesMainToJapesLobby" },
    ...
    { dest = "CreepyCastleLobby", logic = function() return ((settings.open_lobbies() or state.event("ForestKeyTurnedIn")) and (state.cannons() or state.assumeLevel7Entry())) end, exitShuffleId="Transitions.IslesMainToCastleLobby" },
...
M.regions["Prison"] = {
  ...
  exits = {
    { dest = "KremIsle", logic = function() return true end, exitShuffleId="Transitions.IslesPrisonToMain" },
  },
}
...
M.regions["BananaFairyRoom"] = {
  ...
  exits = {
    { dest = "OuterIsles", logic = function() return true end, exitShuffleId="Transitions.IslesFairyToMain" },
...
M.regions["JungleJapesLobby"] = {
  ...
  exits = {
    { dest = "IslesMain", logic = function() return true end, exitShuffleId="Transitions.IslesJapesLobbyToMain" },
    { dest = "JungleJapesEntryHandler", logic = function() return state.IsLevelEnterable("JungleJapes") end, exitShuffleId="Transitions.IslesToJapes" },
  },
}
...
M.regions["AngryAztecLobby"] = {
  ...
  exits = {
    { dest = "IslesMainUpper", logic = function() return true end, exitShuffleId="Transitions.IslesAztecLobbyToMain" },
    { dest = "AngryAztecEntryHandler", logic = function() return state.IsLevelEnterable("AngryAztec") end, exitShuffleId="Transitions.IslesToAztec" },
  },
}
...
M.regions["KremIsle"] = {
  ...
  exits = {
    { dest = "IslesMain", logic = function() return true end },
    { dest = "Prison", logic = function() return true end, exitShuffleId="Transitions.IslesMainToPrison" },
    { dest = "GloomyGalleonLobbyEntrance", logic = function() return ((settings.open_lobbies() or state.event("AztecKeyTurnedIn") or state.CanPhaseswim()) and (state.swim() or state.assumeLevel4Entry())) end, exitShuffleId="Transitions.IslesMainToGalleonLobby" },
...
M.regions["KremIsleBeyondLift"] = {
  ...
  exits = {
    { dest = "KremIsle", logic = function() return true end },
    { dest = "IslesSnideRoom", logic = function() return true end, exitShuffleId="Transitions.IslesMainToSnideRoom" },
    { dest = "FranticFactoryLobby", logic = function() return (settings.open_lobbies() or state.event("AztecKeyTurnedIn")) end, exitShuffleId="Transitions.IslesMainToFactoryLobby" },
  },
}
...
M.regions["KremIsleMouth"] = {
  ...
  exits = {
    { dest = "HideoutHelmLobby", logic = function() return (settings.open_lobbies() or (state.event("CavesKeyTurnedIn") and state.event("CastleKeyTurnedIn"))) end, exitShuffleId="Transitions.IslesMainToHelmLobby" },
...
M.regions["IslesSnideRoom"] = {
  ...
  exits = {
    { dest = "KremIsleBeyondLift", logic = function() return true end, exitShuffleId="Transitions.IslesSnideRoomToMain" },
...
M.regions["FranticFactoryLobby"] = {
  ...
  exits = {
    { dest = "KremIsleBeyondLift", logic = function() return true end, exitShuffleId="Transitions.IslesFactoryLobbyToMain" },
    { dest = "FranticFactoryEntryHandler", logic = function() return state.IsLevelEnterable("FranticFactory") end, exitShuffleId="Transitions.IslesToFactory" },
  },
}
...
M.regions["GloomyGalleonLobbyEntrance"] = {
  ...
  exits = {
    { dest = "KremIsle", logic = function() return true end, exitShuffleId="Transitions.IslesGalleonLobbyToMain" },
...
M.regions["GloomyGalleonLobby"] = {
  ...
  exits = {
    ...
    { dest = "GloomyGalleonEntryHandler", logic = function() return state.IsLevelEnterable("GloomyGalleon") end, exitShuffleId="Transitions.IslesToGalleon" },
  },
}
...
M.regions["CabinDoor"] = {
  ...
  exits = {
    ...
    { dest = "FungiForestLobby", logic = function() return true end, exitShuffleId="Transitions.IslesMainToForestLobby" },
  },
}
...
M.regions["FungiForestLobby"] = {
  ...
  exits = {
    { dest = "CabinIsle", logic = function() return true end, exitShuffleId="Transitions.IslesForestLobbyToMain" },
    { dest = "FungiForestEntryHandler", logic = function() return state.IsLevelEnterable("FungiForest") end, exitShuffleId="Transitions.IslesToForest" },
  },
}
...
M.regions["CrystalCavesLobby"] = {
  ...
  exits = {
    { dest = "IslesEar", logic = function() return true end, exitShuffleId="Transitions.IslesCavesLobbyToMain" },
    { dest = "CrystalCavesEntryHandler", logic = function() return state.IsLevelEnterable("CrystalCaves") end, exitShuffleId="Transitions.IslesToCaves" },
  },
}
...
M.regions["CreepyCastleLobby"] = {
  ...
  exits = {
    { dest = "IslesMain", logic = function() return true end, exitShuffleId="Transitions.IslesCastleLobbyToMain" },
    { dest = "CreepyCastleEntryHandler", logic = function() return state.IsLevelEnterable("CreepyCastle") end, exitShuffleId="Transitions.IslesToCastle" },
  },
}
...
M.regions["HideoutHelmLobby"] = {
  ...
  exits = {
    { dest = "KremIsleMouth", logic = function() return true end, exitShuffleId="Transitions.IslesHelmLobbyToMain" },
...
M.regions["HideoutHelmLobbyPastVines"] = {
  ...
  exits = {
    ...
    { dest = "HideoutHelmEntry", logic = function() return state.IsLevelEnterable("HideoutHelm") end, exitShuffleId="Transitions.IslesToHelm" },
  },
}
