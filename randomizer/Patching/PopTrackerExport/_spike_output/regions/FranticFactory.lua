...
M.regions["FranticFactoryEntryHandler"] = {
  ...
  exits = {
    { dest = "FranticFactoryLobby", logic = function() return true end, exitShuffleId="Transitions.FactoryToIsles" },
...
M.regions["FactoryTinyRace"] = {
  ...
  exits = {
    { dest = "FactoryTinyRaceLobby", logic = function() return true end, exitShuffleId="Transitions.FactoryRaceToRandD" },
  },
}
...
M.regions["FactoryArcadePole"] = {
  ...
  exits = {
    ...
    { dest = "BeyondHatch", logic = function() return true end, exitShuffleId="Transitions.FactoryArcadeToStorage" },
  },
}
...
M.regions["LowerCore"] = {
  ...
  exits = {
    ...
    { dest = "FranticFactoryStart", logic = function() return (state.event("HatchOpened") and state.climbing()) end },
    { dest = "InsideCore", logic = function() return (state.event("MainCoreActivated") or state.CanPhase()) end, exitShuffleId="Transitions.FactoryLowerCoreToInsideCore" },
...
M.regions["InsideCore"] = {
  ...
  exits = {
    { dest = "LowerCore", logic = function() return true end, exitShuffleId="Transitions.FactoryInsideCoreToLowerCore" },
  },
}
...
M.regions["MiddleCore"] = {
  ...
  exits = {
    ...
    { dest = "InsideCore", logic = function() return state.ledgeclip() end, exitShuffleId="Transitions.FactoryLowerCoreToInsideCore", isGlitchTransition=true },
  },
}
