...
M.regions["CreepyCastleEntryHandler"] = {
  ...
  exits = {
    { dest = "CreepyCastleLobby", logic = function() return true end, exitShuffleId="Transitions.CastleToIsles" },
...
M.regions["CastleWaterfall"] = {
  ...
  exits = {
    { dest = "CreepyCastleMain", logic = function() return true end },
    { dest = "UpperCave", logic = function() return true end, exitShuffleId="Transitions.CastleWaterfallToUpper" },
  },
}
...
M.regions["CastleTinyRace"] = {
  ...
  exits = {
    { dest = "MuseumBehindGlass", logic = function() return true end, exitShuffleId="Transitions.CastleRaceToMuseum" },
  },
}
...
M.regions["Tower"] = {
  ...
  exits = {
    { dest = "CreepyCastleMain", logic = function() return true end, exitShuffleId="Transitions.CastleTowerToMain" },
  },
}
...
M.regions["TrashCan"] = {
  ...
  exits = {
    { dest = "CreepyCastleMain", logic = function() return true end, exitShuffleId="Transitions.CastleTrashToMain" },
  },
}
...
M.regions["Shed"] = {
  ...
  exits = {
    { dest = "CreepyCastleMain", logic = function() return true end, exitShuffleId="Transitions.CastleShedToMain" },
  },
}
...
M.regions["Museum"] = {
  ...
  exits = {
    { dest = "CreepyCastleMain", logic = function() return true end, exitShuffleId="Transitions.CastleMuseumToMain" },
...
M.regions["CastleMinecarts"] = {
  ...
  exits = {
    { dest = "CryptDonkeyRoom", logic = function() return true end, exitShuffleId="Transitions.CastleCartsToCrypt" },
  },
}
...
M.regions["Mausoleum"] = {
  ...
  exits = {
    { dest = "LowerCave", logic = function() return true end, exitShuffleId="Transitions.CastleMausoleumToLower" },
  },
}
...
M.regions["UpperCave"] = {
  ...
  exits = {
    { dest = "CreepyCastleMain", logic = function() return true end, exitShuffleId="Transitions.CastleUpperToMain" },
    { dest = "CastleWaterfall", logic = function() return true end, exitShuffleId="Transitions.CastleUpperToWaterfall" },
    { dest = "Dungeon", logic = function() return true end, exitShuffleId="Transitions.CastleUpperToDungeon" },
...
M.regions["Dungeon"] = {
  ...
  exits = {
    { dest = "UpperCave", logic = function() return true end, exitShuffleId="Transitions.CastleDungeonToUpper" },
  },
}
