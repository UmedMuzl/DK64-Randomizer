...
M.regions["AngryAztecEntryHandler"] = {
  ...
  exits = {
    { dest = "AngryAztecLobby", logic = function() return true end, exitShuffleId="Transitions.AztecToIsles" },
...
M.regions["AztecTinyRace"] = {
  ...
  exits = {
    { dest = "AngryAztecMain", logic = function() return true end, exitShuffleId="Transitions.AztecRaceToMain" },
  },
}
