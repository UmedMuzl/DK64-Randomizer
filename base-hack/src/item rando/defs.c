...
void initActorExpansion(void) {
    ...
    *(short*)(0x80678062) = getLo(&actor_extra_data_sizes[0]);
    // Higher enemy health
    actor_health_damage[183].init_health = 20; // Zinger
    actor_health_damage[238].init_health = 20; // Kremling
    actor_health_damage[206].init_health = 5; // Zinger
    actor_health_damage[194].init_health = 50; // Shooting Vulture
    actor_health_damage[230].init_health = 25; // Ruler
    ...
    actor_health_damage[269].init_health = 20; // Mr. Dice
    actor_health_damage[271].init_health = 20; // Mr. Dice
